...
const Hero = () => {
  return (
    <section 
      id="home" 
      className="relative min-h-screen flex items-center justify-center bg-law-navy text-white overflow-hidden"
    >
      ...
      <div className="container mx-auto px-4 z-10 text-center md:text-left md:ml-16 lg:ml-32">
        <div className="max-w-3xl">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 animate-fade-in">
            Excellence in Legal <span className="text-law-gold">Representation</span>
          </h1>
          ...
          <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 animate-fade-in">
            <Button className="bg-law-gold hover:bg-law-gold/90 text-law-navy text-lg px-8 py-6">
              Our Practice Areas
            </Button>
