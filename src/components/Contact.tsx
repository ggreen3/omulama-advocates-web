...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-law-navy text-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 reveal">
            Contact <span className="text-law-gold">Us</span>
          </h2>
          <div className="w-24 h-1 bg-law-gold mx-auto mb-6 reveal reveal-delay-200"></div>
          <p className="max-w-2xl mx-auto text-gray-300 reveal reveal-delay-400">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="reveal reveal-delay-400">
            <div className="bg-white/5 backdrop-blur-sm p-8 rounded-lg border border-white/10">
              <h3 className="text-2xl font-bold text-law-gold mb-6">Get in Touch</h3>
              ...
              <form>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  <div>
                    ...
                    <input
                      type="text"
                      id="name"
                      className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-md placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-law-gold/50"
                ...
                <Button className="w-full bg-law-gold hover:bg-law-gold/90 text-law-navy font-bold py-3">
                  Send Message
                </Button>
              </form>
            </div>
          ...
          <div className="reveal reveal-delay-600">
            <div className="bg-white/5 backdrop-blur-sm p-8 rounded-lg border border-white/10 h-full">
              <h3 className="text-2xl font-bold text-law-gold mb-6">Contact Information</h3>
              
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="mr-4 text-law-gold">
                    <MapPin size={24} />
                  </div>
                  <div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      info@omulamaadvocates.co.ke<br />
